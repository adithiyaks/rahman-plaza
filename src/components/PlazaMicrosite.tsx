          ...
          {PLAZA_FLOORS.map((floor) => {
            ...
            return (
              <div
                ...
                className={`relative rounded-3xl border transition-all duration-700 ease-out overflow-hidden cursor-pointer flex flex-col justify-center ${isActive
                ...
                {isActive && (
                  <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none">
                    <img
                      src={floor.image}
                      alt={floor.name}
                      className="w-full h-full object-cover scale-100 brightness-80 transition-all duration-700"
                      referrerPolicy="no-referrer"
                    />
                ...
                <div className="relative z-10 p-6 sm:p-8 flex flex-col justify-between w-full h-full flex-grow">
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    ...
                    <div className="flex items-baseline gap-6">
                      ...
                      <h3 className={`text-base sm:text-lg tracking-wide transition-colors duration-300 font-sans ${isActive ? 'text-white font-medium' : 'text-neutral-300'
                        }`}>
                        {floor.name}
                      </h3>
                    </div>
                    ...
                    <div className="text-left sm:text-right">
                      <span className={`text-[10px] font-mono tracking-widest uppercase transition-colors ${isActive ? 'text-[#c5a059]' : 'text-neutral-400'
                        }`}>
                        {floor.tagline}
                      </span>
                    </div>
          ...
          >
            ...
            <div className="w-full max-w-6xl flex justify-between items-center border-b border-neutral-900 pb-4">
              ...
              <button
                ...
                className="h-10 w-10 rounded-full border border-neutral-800 text-neutral-400 hover:text-white hover:border-neutral-600 flex items-center justify-center transition-colors scroll-m-1 cursor-pointer pointer-events-auto"
            ...
            {/* Center Screen with Glassmorphed Label */}
            <div className="relative w-full max-w-4xl aspect-video my-auto rounded-2xl overflow-hidden border border-neutral-800 shadow-2xl flex items-center justify-center">
              <img
                src={selectedGalleryFloor.image}
              ...
              {/* Center glassmorphed label */}
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="px-6 sm:px-8 py-3 sm:py-4 rounded-xl bg-black/45 backdrop-blur-md border border-white/10 hover:border-white/20 shadow-xl text-white font-mono tracking-widest text-xs sm:text-sm select-none hover:bg-black/55 hover:scale-105 transition-all duration-300 cursor-pointer">
                  {"< Explore 3D view >"}
                </div>
              </div>
            </div>
